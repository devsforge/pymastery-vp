...
[Online live version](https://www.yworks.com/products/yed-live)
is also available.
...
-   High compression ratio in [7z format](https://7-zip.org/7z.html)
...
distribution](https://en.wikipedia.org/wiki/Linux_distribution) on
...
[full-featured](https://sqlite.org/fullsql.html), SQL database
engine.

<https://sqlite.org/>

[^1]: available for installation as a cygwin package

[^2]: available for installation as a cygwin package

[^3]: available for installation as a cygwin package

[^4]: available for installation as a cygwin package
