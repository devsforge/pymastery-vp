...
!!! note
    ...
    Encapsulation mechanism is often confused with *hiding*. It\'s not
...
![image](/../assets/img/wy_ban.jpg){.align-center}

\"Private\" instance variables that cannot be accessed except from inside an
object don\'t exist in Python docs-python:private-variables. It\'s
