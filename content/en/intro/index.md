...
>
> ![guido](/../assets/img/guido-headshot-2019.jpg){width="100px"} Guido van Rossum

# Introduction to Python

![python](/../assets/img/python.svg){width="24px"} **Python** is a high-level, interpreted scripting language.
...
[![Google](/../assets/img/google.svg){width="64px"}](https://about.google/) [![Facebook](/../assets/img/facebook.svg){width="64px"}](https://www.facebook.com/) [![Instagram](/../assets/img/instagram.svg){width="64px"}](https://about.instagram.com/) [![Spotify](/../assets/img/spotify.svg){width="64px"}](https://support.spotify.com/us/article/what-is-spotify/) [![Quora](/../assets/img/quora.svg){width="64px"}](https://www.quora.com/about) [![Netflix](/../assets/img/netflix.svg){width="64px"}](https://about.netflix.com) [![Dropbox](/../assets/img/dropbox.svg){width="64px"}](https://www.dropbox.com/about)
[![Reddit](/../assets/img/reddit.svg){width="64px"}](https://www.redditinc.com/)
...
There are only 35 docs-python:keywords in Python and they are:
...
::: {#intro .toctree caption="Contents"}
install
interact
